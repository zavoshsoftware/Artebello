...
namespace Artebello.Controllers
{
    ...
    public class ProductGroupsController : Controller
    {
        ...
        public ActionResult Create(ProductGroup productGroup, HttpPostedFileBase fileupload,HttpPostedFileBase headerUpload)
        {
            if (ModelState.IsValid)
            {
                ...
                if (headerUpload != null)
                {
                    ...
                    productGroup.HeaderUrl = newFilenameUrl;
                }
                #endregion
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(ProductGroup productGroup, HttpPostedFileBase fileupload,HttpPostedFileBase headerUpload)
        {
            if (ModelState.IsValid)
            {
                #region Upload and resize image if needed
