...
namespace Artebello.Controllers
{
    public class NewsLettersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] NewsLetter newsLetter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,IsActive,CreationDate,LastModifiedDate,IsDeleted,DeletionDate,Description")] NewsLetter newsLetter)
        {
            if (ModelState.IsValid)
            {
				newsLetter.IsDeleted=false;
